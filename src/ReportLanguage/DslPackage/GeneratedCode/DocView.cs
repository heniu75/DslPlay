...
namespace Company.ReportLanguage
{
	...
	/// </summary>
	internal partial class ReportLanguageDocView : ReportLanguageDocViewBase
	{
		/// <summary>
		/// Constructs a new ReportLanguageDocView.
		/// </summary>
		public ReportLanguageDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ReportLanguageDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ReportLanguageDocView.
		/// </summary>
		protected ReportLanguageDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ReportLanguageDocDataBase docData = this.DocData as ReportLanguageDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ReportLanguageDocViewBase should be an ReportLanguageDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.ReportLanguage.ReportLanguageDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.ReportLanguage.ReportLanguageDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.ReportLanguage.ReportLanguageToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.ReportLanguage.ReportLanguageToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ReportLanguageDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.ReportLanguage.ReportLanguageHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.ReportLanguage.ReportLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.ReportLanguage.ReportLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
