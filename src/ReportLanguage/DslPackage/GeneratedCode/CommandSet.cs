...
namespace Company.ReportLanguage
{
	...
	/// </summary>
	internal partial class ReportLanguageCommandSet : ReportLanguageCommandSetBase
	{
		/// <summary>
		/// Constructs a new ReportLanguageCommandSet.
		/// </summary>
		public ReportLanguageCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ReportLanguageCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ReportLanguageCommandSetBase.
		/// </summary>
		protected ReportLanguageCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewReportLanguageExplorerCommand,
				typeof(ReportLanguageEditorFactory).GUID);
		...
		{
			ReportLanguageExplorerToolWindow explorer = this.ReportLanguageExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected ReportLanguageDocData CurrentReportLanguageDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ReportLanguageDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ReportLanguageDocView CurrentReportLanguageDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ReportLanguageDocView;
			}
		}
		...
		/// </summary>
		protected ReportLanguageExplorerToolWindow ReportLanguageExplorerToolWindow
		{
			get
			{
				ReportLanguageExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ReportLanguageExplorerToolWindow), true) as ReportLanguageExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ReportLanguageExplorerToolWindow explorerWindow = this.ReportLanguageExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ReportLanguageClipboardCommandSet : ReportLanguageClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ReportLanguageClipboardCommandSet.
		/// </summary>
		public ReportLanguageClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ReportLanguageClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ReportLanguageClipboardCommandSetBase.
		/// </summary>
		protected ReportLanguageClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
