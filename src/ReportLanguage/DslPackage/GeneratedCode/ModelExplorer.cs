...
namespace Company.ReportLanguage
{
	...
	/// </summary>
	internal partial class ReportLanguageExplorer : ReportLanguageExplorerBase
	{
		/// <summary>
		/// Constructs a new ReportLanguageExplorer.
		/// </summary>
		public ReportLanguageExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the ReportLanguageExplorerToolWindow.
	/// </summary>
	internal abstract class ReportLanguageExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new ReportLanguageExplorerBase.
		/// </summary>
		protected ReportLanguageExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.ReportLanguageExplorerMenu;
			}
		}
