...
namespace Company.ReportLanguage
{
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"ReportLanguage", typeof(ReportLanguageEditorFactory))]

	internal abstract partial class ReportLanguagePackageBase : DslShell::ModelingPackage
	{
		protected global::Company.ReportLanguage.ReportLanguageToolboxHelper toolboxHelper;	
		...
		protected override void Initialize()
		{
			...
			this.RegisterEditorFactory(new ReportLanguageEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::Company.ReportLanguage.ReportLanguageToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			ReportLanguageCommandSet commandSet = new ReportLanguageCommandSet(this);
			commandSet.Initialize();
			
			// Create the command set that handles cut/copy/paste commands provided by this package.
			ReportLanguageClipboardCommandSet clipboardCommandSet = new ReportLanguageClipboardCommandSet(this);
			clipboardCommandSet.Initialize();
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(ReportLanguageExplorerToolWindow));
...
namespace Company.ReportLanguage
{
	...
	[global::Microsoft.VisualStudio.TextTemplating.VSHost.ProvideDirectiveProcessor(typeof(global::Company.ReportLanguage.ReportLanguageDirectiveProcessor), global::Company.ReportLanguage.ReportLanguageDirectiveProcessor.ReportLanguageDirectiveProcessorName, "A directive processor that provides access to ReportLanguage files")]
	[global::System.Runtime.InteropServices.Guid(Constants.ReportLanguagePackageId)]
	internal sealed partial class ReportLanguagePackage : ReportLanguagePackageBase
	{
	}
}