...
namespace Company.ReportLanguage
{
	...
	/// </remarks>
	public partial class ReportLanguageToolboxHelper : ReportLanguageToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new ReportLanguageToolboxHelper.
		/// </summary>
		public ReportLanguageToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class ReportLanguageToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify ReportLanguage toolbox items.  
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructs a new ReportLanguageToolboxHelperBase.
		/// </summary>
		protected ReportLanguageToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.ReportLanguage.ReportLanguageDomainModel));
