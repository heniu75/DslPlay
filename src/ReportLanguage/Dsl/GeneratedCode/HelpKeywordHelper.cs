...
namespace Company.ReportLanguage
{
	...
	/// </remarks>
	public partial class ReportLanguageHelpKeywordHelper : ReportLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ReportLanguageHelpKeywordHelper.
		/// </summary>
		protected ReportLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ReportLanguageHelpKeywordHelper.
		/// </summary>
		public static ReportLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ReportLanguageHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ReportLanguageHelpKeywordHelperBase.
		/// </summary>
		protected ReportLanguageHelpKeywordHelperBase()
			: base() { }
